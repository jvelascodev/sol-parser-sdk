...
pub mod raydium_cpmm {
    ...
    fn parse_swap(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        ...
        return parse_swap_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_swap_zero_copy(data, metadata);
    ...
    fn parse_deposit(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_deposit_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_deposit_zero_copy(data, metadata);
    ...
    fn parse_withdraw(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_withdraw_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_withdraw_zero_copy(data, metadata);
...
pub mod orca {
    ...
    fn parse_liquidity_increased(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_liquidity_increased_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_liquidity_increased_zero_copy(data, metadata);
    ...
    fn parse_liquidity_decreased(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_liquidity_decreased_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_liquidity_decreased_zero_copy(data, metadata);
...
pub mod meteora_damm {
    ...
    pub mod discriminators {
        pub const SWAP: [u8; 16] =
            [27, 60, 21, 213, 138, 170, 187, 147, 155, 167, 108, 32, 122, 76, 173, 64];
        pub const ADD_LIQUIDITY: [u8; 16] =
            [175, 242, 8, 157, 30, 247, 185, 169, 155, 167, 108, 32, 122, 76, 173, 64];
        pub const REMOVE_LIQUIDITY: [u8; 16] =
            [87, 46, 88, 98, 175, 96, 34, 91, 155, 167, 108, 32, 122, 76, 173, 64];
        pub const CREATE_POSITION: [u8; 16] =
            [156, 15, 119, 198, 29, 181, 221, 55, 155, 167, 108, 32, 122, 76, 173, 64];
        pub const CLOSE_POSITION: [u8; 16] =
            [20, 145, 144, 68, 143, 142, 214, 178, 155, 167, 108, 32, 122, 76, 173, 64];
    }
    ...
    fn parse_add_liquidity(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_add_liquidity_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_add_liquidity_zero_copy(data, metadata);
    ...
    fn parse_remove_liquidity(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_remove_liquidity_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_remove_liquidity_zero_copy(data, metadata);
    ...
    fn parse_create_position(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_create_position_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_create_position_zero_copy(data, metadata);
    ...
    fn parse_close_position(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_close_position_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_close_position_zero_copy(data, metadata);
...
pub mod bonk {
    ...
    fn parse_trade(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_trade_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_trade_zero_copy(data, metadata);
...
pub mod meteora_dlmm {
    ...
    fn parse_initialize_pool(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_initialize_pool_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_initialize_pool_zero_copy(data, metadata);
    ...
    fn parse_initialize_bin_array(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_initialize_bin_array_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_initialize_bin_array_zero_copy(data, metadata);
    ...
    fn parse_claim_fee(data: &[u8], metadata: EventMetadata) -> Option<DexEvent> {
        #[cfg(feature = "parse-borsh")]
        return parse_claim_fee_borsh(data, metadata);

        #[cfg(all(not(feature = "parse-borsh"), feature = "parse-zero-copy"))]
        return parse_claim_fee_zero_copy(data, metadata);
